...
import 'package:classified_apps/apps/views/splash/localization/app_localizations_delegate.dart';
      ...
      try {
        ...
        await http.get(url).then((response) {
          ...
          if (body["status"] == 1) {
            ...
            ls.setString(locale.languageCode, jsonString).then((value) =>
                print("mmmmmmmmmmmmmmmmmmmmmmmm $value mmmmmmmmmmmmmmmmmmm"));
