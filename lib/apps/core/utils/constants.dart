...
const propertySizeList = ["sqft","hectare", "acre", "decimal"];
const propertyPriceList = ["total price","per sqft","per hectare", "per acre", "per decimal"];
...
const sizeList = ["Small","Medium","Large","Extra large","Double extra large"];
